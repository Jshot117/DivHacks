...
const MainHeader = () => {
  ...
  return (
    ...
    <nav className="fixed z-30 w-full border-b border-gray-200 dark:bg-gray-800/75 dark:border-gray-700 backdrop-blur transition-colors duration-500 dark:border-slate-50/[0.06] bg-white/75">
